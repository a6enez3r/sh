...
func responseHandler(
	h func(ctx *fasthttp.RequestCtx) (interface{}, int, error),
	...
	return func(ctx *fasthttp.RequestCtx) {
		...
		err = json.NewEncoder(ctx.Response.BodyWriter()).
			Encode(response{Data: data, Success: err == nil})
		if err != nil {
